  ...
  he: {
    ...
    useCases: {
      ...
      cases: [
        ...
        {
          id: "pandemic_containment",
          title: "בריאות הציבור / ביטחון עולמי – עצירת מגפה לפני שהיא 'מחליפה עולם'",
          desc: "בשבועיים הראשונים של התפרצות נשימתית חדשה, יש אותות חלשים במקביל: עליה חריגה בדלקות ריאה, חוסרים בתרופות חום, פוסטים של רופאים, נתוני ביוב, ותוצאות PCR לא חד-משמעיות. המערכת בונה 'שרשרת ראיות' במקום לחכות.",
          protocol: "PROTOCOL_PANDEMIC_CONTAINMENT",
          clearance: "סודי ביותר / WHO + רגולטורים לאומיים",
          details: {
            fullDesc:
              "אירוע: בשבועיים הראשונים של התפרצות נשימתית חדשה, יש אותות חלשים במקביל: עליה חריגה בדלקות ריאה, חוסרים בתרופות חום, פוסטים של רופאים, נתוני ביוב, ותוצאות PCR לא חד-משמעיות.\nמה TEVEL עושה: מחברת נתוני בתי חולים, מעבדות, ניטור ביוב, תנועת טיסות ותיעוד קליני/פתולוגי, ובונה 'שרשרת ראיות' במקום התרשמות. היא מזהה שהדפוס תואם התפשטות קהילתית ולא אשכול נקודתי, ומדגישה איזה צעדי בלימה הכי יעילים (בידוד ממוקד/איסוף דגימות/הגנת צוותים).",
            capabilities: [
              "היתוך נתוני בריאות חצויים (בתי חולים, מעבדות, ביוב)",
              "זיהוי אנומליות וסיגנלים חלשים בשלבים טרום-אפידמיים",
              "בניית שרשרת התפשטות גיאוגרפית ווירולוגית (Contact Tracing / Flight Patterns)",
              "מודלי התפשטות קהילתית המבוססים על ראיות",
              "יצירת Trigger Tools לצעדי הכלה מדינתיים בשבוע קריטי"
            ],
            impact:
              "החלטה משנה עולם: המלצה מוקדמת ומגובה ראיות לטריגר פעולה בין־מדינתי לפני שבוע 3. מאפשרת ל-WHO ולממשלות לבלום מגפה לפני איבוד שליטה."
          }
        },
        {
          id: "grid_blackout_prevention",
          title: "תשתיות קריטיות / אנרגיה – מניעת 'Blackout בין-מדינתי' שמפיל כלכלה שלמה",
          desc: "גל חום קיצוני + ביקוש שיא לחשמל + תחנת כוח תחת תחזוקה. מערכת הגנה חווה תקלה קטנה שמאיימת ליצור אפקט דומינו. TEVEL מייצרת מודל תלות ומציפה נקודות שבר קריטיות בזמן אמת.",
          protocol: "PROTOCOL_GRID_RESILIENCE",
          clearance: "סודי לאומי / IEA + מפעילי רשת קריטיים",
          details: {
            fullDesc:
              "אירוע: גל חום קיצוני + ביקוש שיא לחשמל + תחנת כוח/קו הולכה מרכזי עם תחזוקה חלקית, ובמקביל תקלה קטנה במערכת הגנה יוצרת cascade.\nמה TEVEL עושה: מחברת SCADA, תוכניות תחזוקה, עומסים, מזג אוויר, זמינות דלק/גז, אירועי עבר וחריגות קטנות בזמן אמת — ובונה מודל תלות שמראה מה יקרוס אחרי מה. היא מציפה 'נקודת שבר' (למשל עומס יתר במקטע ספציפי) ומציעה פעולות דקות-קריטיות: shedding מבוקר באזורים מדויקים, שינוי dispatch, והסטת עומסים לפני שהדומינו מתחיל.",
            capabilities: [
              "חיבור סנסורי SCADA ומערכות ניהול עומס ארציות",
              "מודלי חיזוי Cascade וקריסת שרשרת אספקה/תשתית",
              "אינטגרציית חיזוי מזג ולחצי אנרגיה בזמן-אמת",
              "זיהוי 'נקודת השבר' המדויקת לפי טופולוגיית הרשת",
              "המלצות Load Shedding כירורגי ללא קריסה פאנופבית"
            ],
            impact:
              "החלטה משנה עולם: מניעה של שרשרת ניתוקים ארצית (Cascade Failure) שמפרקת תעשייה, בתי חולים ותחבורה לימים ארוכים."
          }
        },
        {
          id: "global_cyber_vulnerability",
          title: "סייבר מתקדם / Big Tech – 'Log4Shell הבא' (פרצת תוכנה גלובלית)",
          desc: "חולשה בספריית קוד נפוצה מתגלה בעולם. ארגונים לא יודעים היכן היא רצה בגופי הענק שלהם. תוקפים מתחילים לנצל תוך שעות. TEVEL בונה מפת חשיפה מדויקת ולא 'רשימת מכולת'.",
          protocol: "PROTOCOL_GLOBAL_CYBER_CRISIS",
          clearance: "סודי / NIST + ענקיות טכנולוגיה",
          details: {
            fullDesc:
              "אירוע: חולשה בספרייה נפוצה מתגלה, אבל ארגונים ענקיים לא יודעים איפה היא רצה: בתוך מיקרו-שירותים, קונטיינרים, ספקי צד ג', וגרסאות ישנות. התוקפים מתחילים ניצול בתוך שעות.\nמה TEVEL עושה: קוראת SBOMs, תלויות build, רג'יסטרי images, נתוני CMDB, לוגים, tickets, קונפיגים ודיווחי EDR/SIEM — ומייצרת 'מפת חשיפה אמיתית' במקום רשימת ניחושים חסרת פוקוס. היא מדרגת מה לתקן ראשון לפי 'Blast Radius' + קריטיות עסקית משולבת, ומפיקה Audit Trail מוכח עבור רגולטורים וביטוח סייבר.",
            capabilities: [
              "פענוח סבך SBOMs ויצירת גרף תלויות עמוק בארגון",
              "זיהוי Blind Spots ב-CMDB והצלבת EDR/SIEM",
              "תעדוף חולשות אגרסיבי ממוקד ב-Blast Radius מדויק",
              "יצירת מסלולי תיקון מדויקים לפלוגות DevOps שונות",
              "הפקת שרשרת ביקורת להגנת ציות וניהול סיכונים חוקי"
            ],
            impact:
              "החלטה משנה עולם: מקטינה חלון ניצול של Zero-Day מימים לשעות בודדות – ומונעת Disruption רחב בחברות תשלומים, ענן, בריאות וממשל."
          }
        }
      ]
    },
