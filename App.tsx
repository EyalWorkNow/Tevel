                            ...
                            {isActive && (
                                <circle r="3" fill="#34d399">
                                    <animateMotion 
                                        ...
                                        path={`M ${50 + (50 - pos.x) * 4}% ${50 + (50 - pos.y) * 4}% L 50% 50%`}
                                    />
                                </circle>
                            )}
                        </svg>
...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen text-white relative selection:bg-emerald-500/30 ${isRtl ? 'font-hebrew' : ''} overflow-x-hidden bg-[#0F1115]`}>
      ...
      <header id="hero" 
        className="relative pt-32 md:pt-40 pb-20 md:pb-32 px-4 md:px-6 min-h-screen flex flex-col items-center justify-center text-center overflow-hidden perspective-2000"
        onMouseMove={handleMouseMove}
        onMouseLeave={handleMouseLeave}
      >
        ...
        >
          <div style={{ transform: "translateZ(50px)" }}>
            <TerminalHero prefix={t.hero.terminalPrefix} />
          </div>
