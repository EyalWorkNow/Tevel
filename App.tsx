...
import SolutionEngine from './components/SolutionEngine';
...
// --- Solution Engine Components Moved to SolutionEngine.tsx ---
    ...
    <div className={`min-h-screen text-white relative selection:bg-emerald-500/30 ${isRtl ? 'font-hebrew' : ''} overflow-x-hidden bg-[#0F1115]`}>
      ...
      >
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <motion.button
            ...
            className="text-slate-400 hover:text-white transition-colors flex items-center gap-2 text-xs font-mono border border-white/10 rounded-full px-3 py-1.5 md:px-4 md:py-2 hover:border-emerald-500/50 hover:bg-emerald-500/10 hover:shadow-[0_0_15px_rgba(16,185,129,0.2)] active:scale-95 duration-200"
          >
            <Globe size={14} />
      ...
      <section id="solution" className="py-20 md:py-40 px-4 md:px-6 overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-10 relative z-10">
          ...
          {/* Interactive Orbital Engine with Tooltips */}
          <SolutionEngine t={t} />
