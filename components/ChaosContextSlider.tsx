                    ...
                    <svg className="absolute inset-0 w-full h-full pointer-events-none">
                       ...
                       {contextNodes.map((node, i) => (
                           <React.Fragment key={i}>
                               <motion.path 
                                    d={`M 50% 50% L ${node.left} ${node.top}`} 
                                    stroke="#10b981" 
                                    strokeWidth="1" 
                               ...
                               <motion.circle r="3" fill="#34d399">
                                   <animateMotion 
                                        ...
                                        keyPoints="1;0"
                                        keyTimes="0;1"
                                        path={`M 50% 50% L ${node.left} ${node.top}`} 
                                   />
                               </motion.circle>
                           </React.Fragment>
                       ))}
                       ...
                       {/* Pulse Rings */}
                       <circle cx="50%" cy="50%" r="18%" fill="none" stroke="#10b981" strokeWidth="0.5" className="animate-[ping_4s_cubic-bezier(0,0,0.2,1)_infinite] opacity-20" />
                    </svg>
